...
function generateOverlays() {
  ...
  components.forEach(component => {
    ...
    componentImports.push(`import { defineCustomElement as ${defineCustomElementFn} } from '@lawsafrica/law-widgets/components/${component.tag}.js'`);
...
} from '@lawsafrica/law-widgets/components';
