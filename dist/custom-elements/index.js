...
const AkomaNtoso = class extends HTMLElement$1 {
  constructor() {
    super();
    this.__registerHost();
...
const DecorateExternalRefs = class extends HTMLElement$1 {
  constructor() {
    super();
    this.__registerHost();
    this.tippies = [];
...
const DecorateInternalRefs = class extends HTMLElement$1 {
  constructor() {
    super();
    this.__registerHost();
    this.tippies = [];
...
const DecorateTerms = class extends HTMLElement$1 {
  constructor() {
    super();
    this.__registerHost();
...
const Gutter = class extends HTMLElement$1 {
  constructor() {
    super();
    this.__registerHost();
...
const GutterItem = class extends HTMLElement$1 {
  constructor() {
    super();
    this.__registerHost();
...
const TableOfContents = class extends HTMLElement$1 {
  constructor() {
    super();
    this.__registerHost();
    /**
...
const TableOfContentsController = class extends HTMLElement$1 {
  constructor() {
    super();
    this.__registerHost();
    /**
...
const TocItem = class extends HTMLElement$1 {
  constructor() {
    super();
    this.__registerHost();
...
const LaAkomaNtoso = /*@__PURE__*/proxyCustomElement(AkomaNtoso, [0,"la-akoma-ntoso",{"frbrExpressionUri":[1537,"frbr-expression-uri"],"frbrCountry":[1537,"frbr-country"],"frbrType":[1537,"frbr-type"],"frbrSubtype":[1537,"frbr-subtype"],"frbrAuthor":[1537,"frbr-author"],"frbrDate":[1537,"frbr-date"],"frbrNumber":[1537,"frbr-number"],"frbrExpressionDate":[1537,"frbr-expression-date"],"frbrLanguage":[1537,"frbr-language"],"fetch":[1540],"partner":[1537],"provider":[1]}]);
const LaDecorateExternalRefs = /*@__PURE__*/proxyCustomElement(DecorateExternalRefs, [0,"la-decorate-external-refs",{"akomaNtoso":[1,"akoma-ntoso"],"popups":[4],"partner":[1],"provider":[1]}]);
const LaDecorateInternalRefs = /*@__PURE__*/proxyCustomElement(DecorateInternalRefs, [0,"la-decorate-internal-refs",{"akomaNtoso":[1,"akoma-ntoso"],"popups":[4],"flag":[4],"fetch":[1540],"partner":[1537],"provider":[1]}]);
...
export { LaAkomaNtoso, LaDecorateExternalRefs, LaDecorateInternalRefs, LaDecorateTerms, LaGutter, LaGutterItem, LaTableOfContents, LaTableOfContentsController, LaTocItem, defineCustomElements };
