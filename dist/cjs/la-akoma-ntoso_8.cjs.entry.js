...
const tippy_esm = require('./tippy.esm-f7850f80.js');
...
let DecorateInternalRefs = class {
  ...
  componentWillLoad() {
    ...
    this.akomaNtosoElement = tippy_esm.getAkomaNtosoElement(this.el, this.akomaNtoso);
...
let DecorateTerms = class {
  ...
  createPopups() {
    // @ts-ignore
    this.tippies = tippy_esm.tippy('.akn-term', {
      appendTo: () => this.tippyContainer,
      allowHTML: true,
      content: '',
      hideOnClick: true,
