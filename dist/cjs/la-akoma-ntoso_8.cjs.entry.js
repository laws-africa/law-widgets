...
let TableOfContents = class {
  ...
  render() {
    const renderTOCItem = (item) => {
      ...
      return (index.h("la-toc-item", { item: item, filteredItems: this.filteredItems, prependHtml: prepend, appendHtml: append, expandIconHtml: expandIcon, collapseIconHtml: collapseIcon }));
    };
    return (index.h(index.Host, null, index.h("div", { style: { display: 'none' } }, index.h("slot", { name: "append" }), index.h("slot", { name: "prepend" }), index.h("slot", { name: "expand-icon" }), index.h("slot", { name: "collapse-icon" })), index.h("div", { class: "toc-items" }, this.innerItems.map(item => renderTOCItem(item)))));
  }
  get el() { return index.getElement(this); }
  static get watchers() { return {
...
const tableOfContentsControllerCss = "la-table-of-contents-controller *{-webkit-box-sizing:border-box;box-sizing:border-box}la-table-of-contents-controller .search{width:100%;margin-bottom:5px}la-table-of-contents-controller .toggle{margin-bottom:5px}la-table-of-contents-controller .toggle__expand-all-btn{margin-right:5px}";
...
let TableOfContentsController = class {
  ...
  render() {
    return (index.h(index.Host, null, index.h("div", { class: "search" }, index.h("input", { class: `search__input ${this.searchFilterInputClasses}`, value: this.titleFilter, placeholder: this.titleFilterPlaceholder, onInput: e => this.handleTitleChange(e) })), index.h("div", { class: "toggle" }, index.h("button", { type: "button", class: `toggle__expand-all-btn ${this.expandAllBtnClasses}`, onClick: () => this.expandAll() }, "Expand All"), index.h("button", { type: "button", class: `toggle__collapse-all-btn ${this.collapseAllBtnClasses}`, onClick: () => this.collapseAll() }, "Collapse All")), index.h("la-table-of-contents", { items: this.items, titleFilter: this.titleFilter }, index.h("span", { slot: "append" }, index.h("slot", { name: "append" })), index.h("span", { slot: "prepend" }, index.h("slot", { name: "prepend" })), index.h("span", { slot: "expand-icon" }, index.h("slot", { name: "expand-icon" })), index.h("span", { slot: "collapse-icon" }, index.h("slot", { name: "collapse-icon" })))));
  }
  get el() { return index.getElement(this); }
};
TableOfContentsController.style = tableOfContentsControllerCss;

const tocItemCss = "la-toc-item{display:-ms-flexbox;display:flex;-ms-flex-direction:row;flex-direction:row;width:100%}la-toc-item *{-webkit-box-sizing:border-box;box-sizing:border-box}la-toc-item .indented{width:1.4em}la-toc-item .content{-ms-flex:1;flex:1}la-toc-item .content__action{display:-ms-flexbox;display:flex;-ms-flex-direction:row;flex-direction:row;-ms-flex-align:center;align-items:center}la-toc-item .content__children{display:none}la-toc-item[expanded]>.content>.content__children{display:inherit}la-toc-item.excluded{display:none}la-toc-item .indented__toggle-btn{background-color:transparent;border:none;-webkit-box-shadow:none;box-shadow:none;cursor:pointer}";
...
let TocItem = class {
  ...
  render() {
    ...
    return (index.h(index.Host, Object.assign({}, (isParent ? { parent: isParent } : {}), { class: `${!showItem ? 'excluded' : ''}` }), index.h("div", { class: "indented" }, isParent ? (index.h("button", { class: "indented__toggle-btn", type: "button", onClick: this.toggle.bind(this) }, renderToggleBtnInner())) : null), index.h("div", { class: "content" }, index.h("div", { class: "content__action" }, this.prependHtml ? index.h("div", { class: "content__action__prepend", innerHTML: this.prependHtml }) : null, index.h("a", { href: `#${this.item.id || ''}`, class: "content__action__title" }, this.item.title), this.appendHtml ? index.h("div", { class: "content__action__append", innerHTML: this.appendHtml }) : null), index.h("div", { class: "content__children" }, this.item.children && this.item.children.length
      ? this.item.children.map((item) => (index.h("la-toc-item", { item: item, filteredItems: this.filteredItems, prependHtml: this.prependHtml, appendHtml: this.appendHtml, expandIconHtml: this.expandIconHtml, collapseIconHtml: this.collapseIconHtml })))
      : null))));
  }
};
