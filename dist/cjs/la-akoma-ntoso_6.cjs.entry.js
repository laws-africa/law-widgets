...
const tippy_esm = require('./tippy.esm-18cde9a6.js');
...
const DecorateExternalRefs = class {
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
    this.tippies = [];
    /**
  ...
  createPopups() {
    if (this.akomaNtosoElement) {
      // @ts-ignore
      this.tippies = tippy_esm.tippy(this.akomaNtosoElement.querySelectorAll('a.akn-ref[data-href^="/akn/"]'), {
...
const DecorateInternalRefs = class {
  ...
  createPopups() {
    // @ts-ignore
    this.tippies = tippy_esm.tippy('a.akn-ref[href^="#"]', {
      appendTo: () => this.tippyContainer,
      allowHTML: true,
      hideOnClick: true,
      interactive: true,
...
const TocItem = class {
  ...
  render() {
    ...
    return (index.h(index.Host, Object.assign({}, (isParent ? { parent: isParent } : {}), { class: `${!showItem ? 'excluded' : ''}` }), index.h("div", { class: "indented" }, isParent
      ? (index.h("div", { class: "indented__toggle-btn", role: "button", onClick: () => this.toggle() }, renderToggleBtnInner()))
...
exports.la_decorate_external_refs = DecorateExternalRefs;
