...
const TableOfContents = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'f8b5eaf0e2c359af4eea3b7d6ab3fcad94f393bb' }, index.h("div", { key: 'ddca6abce36c9be705a172c12e833a6f9d088b89', style: { display: 'none' } }, index.h("slot", { key: '6f55f20f2cb614bb7a7519c44a71f2f94ff60b14', name: "expand-icon" }), index.h("slot", { key: '9bc755de6658047c64c1c3f5e42a4b6342a883f8', name: "collapse-icon" })), this.innerItems.map((item) => this.renderItem(item))));
    }
...
//# sourceMappingURL=la-table-of-contents.cjs.entry.js.map