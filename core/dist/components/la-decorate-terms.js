...
const DecorateTerms = /*@__PURE__*/ proxyCustomElement(class DecorateTerms extends H {
    constructor() {
        super();
        this.__registerHost();
    ...
    makeTermLinks() {
        if (this.akomaNtosoElement) {
            this.akomaNtosoElement.addEventListener('click', (e) => {
                if (e.target && e.target instanceof H) {
                    const el = e.target;
    ...
    static get style() { return LaDecorateTermsStyle0; }
}, [0, "la-decorate-terms", {
...
export { LaDecorateTerms, defineCustomElement };

//# sourceMappingURL=la-decorate-terms.js.map