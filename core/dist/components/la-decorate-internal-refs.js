...
const DecorateInternalRefs = /*@__PURE__*/ proxyCustomElement(class DecorateInternalRefs extends H {
    constructor() {
        super();
        this.__registerHost();
        this.tippies = [];
    ...
    static get style() { return LaDecorateInternalRefsStyle0; }
...
//# sourceMappingURL=la-decorate-internal-refs.js.map