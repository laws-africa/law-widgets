...
| `collapseAllBtnText`         | `collapse-all-btn-text`          | Button text for collapse all button                                                                                                                                                                                         | `string`              | `''`                             |
| `expandAllBtnClasses`        | `expand-all-btn-classes`         | Additional classes added to Expand all button                                                                                                                                                                               | `string`              | `''`                             |
| `expandAllBtnText`           | `expand-all-btn-text`            | Button text for expand all button                                                                                                                                                                                           | `string`              | `''`                             |
